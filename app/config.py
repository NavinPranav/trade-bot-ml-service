...
class Settings(BaseSettings):
    ...
    gemini_min_risk_reward: float = 0.0
    ...
    gemini_relaxed_confidence_floor_strong_trend: float = 0.0
    # SELL + checklist near support (S1/S2): require higher confidence to cut false SELLs into support.
    gemini_sell_near_support_min_confidence: float = 0.0
    ...
    gemini_trend_guardrail_enabled: bool = False
